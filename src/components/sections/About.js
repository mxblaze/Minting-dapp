  ...
  return (
    ...
    <Section id="about"  >
      ...
      <Container style = {{ transform: `translateY(${offsetY*0.08}px)`}}>
        ...
        <Box2 >
          ...
          <br /> MEEBLES ARE DA WEIRD CREATURES, <br />
            ...
            <SubText>
            <br />ON DA VERY SIMPLY DAY OF <br />
       ...
       <ContainerFooter style = {{ transform: `translateY(${offsetY*0.08}px)`}}></ContainerFooter> 
      <Bottom style = {{ transform: `translateY(${offsetY*0.08}px)`}}>
        ...
        <span style = {{color:"black"}}> Da mother and da father  of meeble has 
        waived all copyright and related  rights  to da  lost meeble
        </span>
